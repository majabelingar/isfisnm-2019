...
io.sockets.on("connection", function(socket) {
    socket.on("ukazArduinu", function(štUkaza) {
        ...
        if (štUkaza == "3") {
            board.digitalWrite(8, board.HIGH); // zapišemp +5V na p. 8 
        }
        if (štUkaza == "2") {
            board.digitalWrite(8, board.LOW); // zapišemo 0V na pin8
        }
        if (štUkaza == "5") {
            board.digitalWrite(12, board.HIGH); // zapišemo +5V na p. 12
        }
        if (štUkaza == "4") {
            board.digitalWrite(12, board.LOW); // zapišemo 0V na pin12
        }
        if (štUkaza == "7") {
