...
http.createServer(function(req, res){ // http.createServer([requestListener])
    ...
    res.write("Za test vpišite v brskalnikovo vrstico z naslovom: http://192.168.1.206:8080/1 <br>");
    res.write("ali: http://192.168.1.206:8080/0<br>");
    res.end("Vrednost operatorja: " + operator);
}).listen(8080, "192.168.1.206");